...
namespace ITS.Snap7.Library
{
    ...
    {
        //#region PLC Connected Event (Added by IMEL)
        //public delegate void ConnectedEventHandler(object sender, ConnectionEventArgs s);
        //public event ConnectedEventHandler PLCConnected;
        //protected virtual void OnInviaComunicazione(ConnectionEventArgs e)
        //{
        //    ConnectedEventHandler handler = PLCConnected;
        ...
        {
            //OnInviaComunicazione(new ConnectionEventArgs(false));
        ...
        public bool Connected()
        {
            ...
            {
                //OnInviaComunicazione(new ConnectionEventArgs(true));
